...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWlnaHR5ZWFnbGUiLCJhIjoiY2s5enh6bzkzMGI2MTNzcnRkNzU0cDcxMCJ9.bQ-uSbf8te7DFAOHV-lxbg';
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: 'http://127.0.0.1:2207/api/v1/users/login',
              data: {
                email: email,
                password: password
              }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: 'http://127.0.0.1:2207/api/v1/users/logout'
            });
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:2207/api/v1/users/updateMyPassword' : 'http://127.0.0.1:2207/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _stripeJs.loadStripe)('pk_test_51HA8rvFipmgBai7IgM0jOfFUB8nGprOLDn4Y2LnZIUux92C6VwBVUV8tKWKIDbTGae3eqbrqKGS6B86P0lwfdLu600uSottIgy');

          case 3:
            stripe = _context.sent;
            _context.next = 6;
            return (0, _axios.default)("http://127.0.0.1:2207/api/v1/bookings/checkout-session/".concat(tourId));
          ...
          case 6:
            ...
            return stripe.redirectToCheckout({
              sessionId: "".concat(session.data.session.id)
            });
